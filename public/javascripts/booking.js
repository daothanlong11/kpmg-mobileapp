...
var single_dose_count = 0;
var combo_dose_count = 0;
var user_booking = {
  single_dose: {},
  single_dose_location: {},
  combo_dose: {},
  combo_dose_location: {},
};
...
function confirm_button() {
  ...
  request.addEventListener("load", function (e) {
    if (request.response === "undefined") {
      ...
      setTimeout(function () {
        ...
        document.getElementById("booking-birth").value =
        ...
        document.getElementById("booking-district").value =
          user_data["district"];
      }, 1000);
    }
  });
  ...
  request.send(
    "vaccination_code" + "=" + document.getElementById("vaccination_code").value
  );
}
...
function choose_single_dose() {
  if (
    document.getElementById("booking-content-vaccines-doses-menu-1").value !=
    "none"
  ) {
    var single_location = document.getElementById(
      "booking-content-vaccines-locations-menu"
    );
...
function choose_combo_dose() {
  if (
    document.getElementById("booking-content-vaccines-doses-menu-2").value !=
    "none"
  ) {
    var combo_location = document.getElementById(
      "booking-content-vaccines-locations-menu"
    );
...
function single_dose() {
  ...
  if (status == true) {
    document.getElementById(
      "booking-content-vaccines-doses-menu-1"
    ).style.display = "block";
    document.getElementById(
      "booking-content-vaccines-doses-menu-2"
    ).style.display = "none";
...
function choose_button() {
  var single_dose = document.getElementById(
    "booking-content-vaccines-doses-menu-1"
  ).value;
  if (single_dose != "none") {
    var single_dose_location = document.getElementById(
      "booking-content-vaccines-locations-menu"
    ).value;
    user_booking.single_dose[single_dose_count.toString()] = single_dose;
    user_booking.single_dose_location[single_dose_count.toString()] =
      single_dose_location;
    single_dose_count += 1;
  }

  var combo_dose = document.getElementById(
    "booking-content-vaccines-doses-menu-2"
  ).value;
  if (combo_dose != "none") {
    var combo_dose_location = document.getElementById(
      "booking-content-vaccines-locations-menu"
    ).value;
    user_booking.combo_dose[combo_dose_count.toString()] = combo_dose;
    user_booking.combo_dose_location[combo_dose_count.toString()] =
      combo_dose_location;
    combo_dose_count += 1;
  }
